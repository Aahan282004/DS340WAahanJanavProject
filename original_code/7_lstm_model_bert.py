...
train_sentiment_feature = train_sentiment[sequence_length:].reshape(-1, 1, 1)
X_train = np.concatenate((X_train, train_sentiment_feature), axis=1)

test_sentiment_feature = test_sentiment[sequence_length:].reshape(-1, 1, 1)
X_test = np.concatenate((X_test, test_sentiment_feature), axis=1)
